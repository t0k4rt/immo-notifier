...
var seLogerSearchAdapter = require('../searchAdapter/seLoger/seLogerAdapter')
  , seLogerListingParser = require('../parserAdapter/seLoger/seLogerListingParser')
  , seLogerAnnonceParser = require('../parserAdapter/seLoger/seLogerAnnonceParser');
...
seLogerSearchAdapter.getListingUrl(search, function(err, res) {
  console.log(res);
});
/**
 * redis setup
